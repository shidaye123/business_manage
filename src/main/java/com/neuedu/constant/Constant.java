...
public class Constant {
    ...
    public static enum orderStatusEnum{
        ...
        public static Constant.orderStatusEnum codeof(Integer code){
            for (Constant.orderStatusEnum orderStatusEnum:values()){
    ...
    public static enum paymentTypeEnum{
        ...
        public static Constant.paymentTypeEnum codeof(Integer code){
            for (Constant.paymentTypeEnum paymentTypeEnum:values()){
